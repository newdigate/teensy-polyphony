...
AudioConnection          patchCord1(_voices[0], 0, i2s1, 0);
AudioConnection          patchCord2(_voices[1], 0, i2s1, 1);
...
void setup() {
    ...
    _sampler.addSample(KEY_NOTENUMBER_C1, (int16_t *)kick_raw, kick_raw_len / 2, 1);
